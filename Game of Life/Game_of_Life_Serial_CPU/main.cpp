...
#define WINDOW_TITLE "Game of Life - Serial CPU implementation"
...
void linearFillGrid(grid_t[SIZE * SIZE], const char * patternFileName);
...
int main(int argc, char** argv)
{
    ...
    linearInitGrid(grid);
    linearFillGrid(grid, patternFileName);
...
void display(void) {
    ...
    for(pos=0; pos < SIZE * SIZE; pos++){
        ...
        if(grid[pos]==ALIVE) glColor3f(0.0, 0.6, 0.0);
